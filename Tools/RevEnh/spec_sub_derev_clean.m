function [ss,ratio,pn_all,x2,ss_out] = spec_sub_derev_clean(s,fs)
% implemented on 4/30/03
% no smoothing, clean spectral subtraction
%function [ss,po]=specsubm(s,fs,p)
%SPECSUBM performs speech enhancement using spectral subtraction [SS,PO]=(S,FS)
%
